...
*/
func (a *DefaultApiService) AssignCentralCluster(ctx _context.Context, id string, centralAssignClusterRequest CentralAssignClusterRequest) (*_nethttp.Response, error) {
	var (
