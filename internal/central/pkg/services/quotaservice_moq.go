...
//			},
//			HasQuotaAllowanceFunc: func(central *dbapi.CentralRequest, instanceType types.CentralInstanceType) (bool, *serviceError.ServiceError) {
//				panic("mock out the HasQuotaAllowance method")
//			},
//			ReserveQuotaFunc: func(ctx context.Context, central *dbapi.CentralRequest, forcedBillingModel string, forcedProduct string) (string, *serviceError.ServiceError) {
...
func (mock *QuotaServiceMock) HasQuotaAllowance(central *dbapi.CentralRequest, instanceType types.CentralInstanceType) (bool, *serviceError.ServiceError) {
	...
	return mock.HasQuotaAllowanceFunc(central, instanceType)
}
...
func (mock *QuotaServiceMock) ReserveQuota(ctx context.Context, central *dbapi.CentralRequest, forcedBillingModel string, forcedProduct string) (string, *serviceError.ServiceError) {
	...
	return mock.ReserveQuotaFunc(ctx, central, forcedBillingModel, forcedProduct)
}
