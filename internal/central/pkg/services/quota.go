...
type QuotaService interface {
	...
	CheckIfQuotaIsDefinedForInstanceType(central *dbapi.CentralRequest, instanceType types.CentralInstanceType) (bool, *errors.ServiceError)
	// ReserveQuota reserves a quota for a user and return the reservation id or an error in case of failure
	ReserveQuota(central *dbapi.CentralRequest, instanceType types.CentralInstanceType) (string, *errors.ServiceError)
