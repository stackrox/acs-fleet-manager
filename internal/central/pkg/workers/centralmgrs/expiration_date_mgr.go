...
func NewExpirationDateManager(centralService services.CentralService, quotaServiceFactory services.QuotaServiceFactory, centralConfig *config.CentralConfig) *ExpirationDateManager {
