...
func NewCentralAuthConfigManager(centralService services.CentralService, iamConfig *iam.IAMConfig, centralConfig *config.CentralConfig) (*CentralAuthConfigManager, error) {
...
func augmentWithStaticAuthConfig(r *dbapi.CentralRequest, centralConfig *config.CentralConfig) error {
	...
	r.ClientOrigin = dbapi.AuthConfigStaticClientOrigin
