...
func (c *DataplaneClusterConfig) AddFlags(fs *pflag.FlagSet) {
	...
	fs.StringVar(&c.DinosaurOperatorOLMConfig.CatalogSourceNamespace, "central-operator-cs-namespace", c.DinosaurOperatorOLMConfig.CatalogSourceNamespace, "Central operator catalog source namespace.")
	fs.StringVar(&c.DinosaurOperatorOLMConfig.IndexImage, "central-operator-index-image", c.DinosaurOperatorOLMConfig.IndexImage, "Central operator index image")
	fs.StringVar(&c.DinosaurOperatorOLMConfig.Namespace, "central-operator-namespace", c.DinosaurOperatorOLMConfig.Namespace, "Central operator namespace")
	fs.StringVar(&c.DinosaurOperatorOLMConfig.Package, "central-operator-package", c.DinosaurOperatorOLMConfig.Package, "Central operator package")
	fs.StringVar(&c.DinosaurOperatorOLMConfig.SubscriptionChannel, "central-operator-sub-channel", c.DinosaurOperatorOLMConfig.SubscriptionChannel, "Central operator subscription channel")
