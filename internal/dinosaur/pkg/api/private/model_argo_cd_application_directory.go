...
// ArgoCdApplicationDirectory struct for ArgoCdApplicationDirectory
type ArgoCdApplicationDirectory struct {
	Recurse bool                     `json:"recurse,omitempty"`
	Jsonnet ArgoCdApplicationJsonnet `json:"jsonnet,omitempty"`
