...
// ApiRhacsV1AdminCentralsIdBillingModelPatchOpts Optional parameters for the method 'ApiRhacsV1AdminCentralsIdBillingModelPatch'
type ApiRhacsV1AdminCentralsIdBillingModelPatchOpts struct {
	CloudAccountId optional.String
	CloudProvider  optional.String
}

/*
ApiRhacsV1AdminCentralsIdBillingModelPatch Rotate RHSSO client of a central tenant
  - @param ctx _context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
  - @param id The ID of record
  - @param organisationId
  - @param optional nil or *ApiRhacsV1AdminCentralsIdBillingModelPatchOpts - Optional Parameters:
  - @param "CloudAccountId" (optional.String) -
  - @param "CloudProvider" (optional.String) -
*/
func (a *DefaultApiService) ApiRhacsV1AdminCentralsIdBillingModelPatch(ctx _context.Context, id string, organisationId string, localVarOptionals *ApiRhacsV1AdminCentralsIdBillingModelPatchOpts) (*_nethttp.Response, error) {
	var (
...
/*
CentralRotateSecrets Rotate RHSSO client or Secret Backup of a central tenant
  - @param ctx _context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
  - @param id The ID of record
  - @param centralRotateSecretsRequest Options for secret rotation
*/
func (a *DefaultApiService) CentralRotateSecrets(ctx _context.Context, id string, centralRotateSecretsRequest CentralRotateSecretsRequest) (*_nethttp.Response, error) {
	var (
		localVarHTTPMethod   = _nethttp.MethodPost
		localVarPostBody     interface{}
		localVarFormFileName string
...
/*
GetCentralTrait Returns central trait status.
  - @param ctx _context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
  - @param id The ID of record
  - @param trait A central trait
*/
func (a *DefaultApiService) GetCentralTrait(ctx _context.Context, id string, trait string) (*_nethttp.Response, error) {
	var (
		localVarHTTPMethod   = _nethttp.MethodGet
		localVarPostBody     interface{}
		localVarFormFileName string
...
/*
UpdateCentralNameById Update `name` central property
  - @param ctx _context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
  - @param id The ID of record
  - @param centralUpdateNameRequest Options for patch operation

@return Central
*/
func (a *DefaultApiService) UpdateCentralNameById(ctx _context.Context, id string, centralUpdateNameRequest CentralUpdateNameRequest) (Central, *_nethttp.Response, error) {
	var (
		localVarHTTPMethod   = _nethttp.MethodPatch
		localVarPostBody     interface{}
		localVarFormFileName string
	...
	// create path and map variables
	localVarPath := a.client.cfg.BasePath + "/api/rhacs/v1/admin/centrals/{id}/name"
	localVarPath = strings.Replace(localVarPath, "{"+"id"+"}", _neturl.QueryEscape(parameterToString(id, "")), -1)
	...
	// body params
	localVarPostBody = &centralUpdateNameRequest
	r, err := a.client.prepareRequest(ctx, localVarPath, localVarHTTPMethod, localVarPostBody, localVarHeaderParams, localVarQueryParams, localVarFormParams, localVarFormFileName, localVarFileName, localVarFileBytes)
	if err != nil {
		return localVarReturnValue, nil, err
	}
