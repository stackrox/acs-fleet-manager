...
type QuotaService interface {
	...
	ReserveQuota(ctx context.Context, dinosaur *dbapi.CentralRequest, instanceType types.DinosaurInstanceType, forceBillingModel string) (string, *errors.ServiceError)
