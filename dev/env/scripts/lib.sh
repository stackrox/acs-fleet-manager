...
init() {
    ...
    export INSTALL_ARGOCD="${INSTALL_ARGOCD:-$INSTALL_ARGOCD_DEFAULT}"
    export INSTALL_OPENSHIFT_GITOPS="${INSTALL_OPENSHIFT_GITOPS:-$INSTALL_OPENSHIFT_GITOPS_DEFAULT}"
    ...
    export SECURE_TENANT_NETWORK=${SECURE_TENANT_NETWORK:-$SECURE_TENANT_NETWORK_DEFAULT}
