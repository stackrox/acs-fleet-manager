...
init() {
    ...
    export ENABLE_DINOSAUR_EXTERNAL_CERTIFICATE=${ENABLE_DINOSAUR_EXTERNAL_CERTIFICATE:-$ENABLE_DINOSAUR_EXTERNAL_CERTIFICATE_DEFAULT}
    export DINOSAUR_DOMAIN_NAME=${DINOSAUR_DOMAIN_NAME:-$DINOSAUR_DOMAIN_NAME_DEFAULT}
