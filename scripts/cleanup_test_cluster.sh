...
# against real OCM environment. It uses a internal/central/test/integration/test_cluster.json file with cluster details created by the tests.

FILE=internal/central/test/integration/test_cluster.json
