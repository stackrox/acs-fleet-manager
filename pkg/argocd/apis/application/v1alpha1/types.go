...
// IgnoreDifferences is a list of resources and their fields which should be ignored during comparison with live state.
...
// KustomizeImage represents a Kustomize image override specification
...
// KustomizeReplica replica override for a Kustomize app
...
// KustomizeReplicas is a list of Kustomize replica override specifications
...
// KustomizeSelector selects resources to apply a Kustomize patch to
...
// KustomizeResID represents a Kustomize resource identifier
...
// KustomizeGvk represents a Kustomize Group Version Kind
...
// ApplicationSourceDirectory holds options for applications sourced from a directory
...
// OptionalMap is a map type parameter for plugins
...
// OptionalArray is an array type parameter for plugins
...
// ApplicationSourcePluginParameter holds a plugin parameter
...
// ApplicationStatus contains information about application status in target cluster
...
// Info contains arbitrary information about an item
type Info struct {
	Name  string `json:"name" protobuf:"bytes,1,name=name"`
...
// ManagedNamespaceMetadata contains metadata to apply to a managed namespace
...
// SyncStrategyApply uses `kubectl apply` to perform the sync
...
// HealthStatus contains information about the application health status
