FROM --platform=$BUILDPLATFORM registry.access.redhat.com/ubi8/go-toolset:1.22.9-1.1736925145 AS build
...
FROM registry.access.redhat.com/ubi8/ubi-minimal:8.10-1154 AS standard
